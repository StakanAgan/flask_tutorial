...
def index():
    ...
    next_url, prev_url = render_post_pagination('index', posts)
...
def user(username):
    ...
    next_url, prev_url = render_user_post_pagination('user', user, posts)
    form = EmptyForm()
...
def explore():
    ...
    next_url, prev_url = render_post_pagination('explore', posts)
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        return redirect((url_for('login')))
    return render_template('reset.html', title=_('Reset Password'), form=form)
